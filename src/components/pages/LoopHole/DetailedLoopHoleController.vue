...
<!--      </el-form>-->
      ...
      <el-button style="display: flex; float: right; margin-bottom: 20px" @click="queryLoopHole">查询漏洞</el-button>
      <el-button style="display: flex; float: right; margin-bottom: 20px" @click="queryCategory">查询分类</el-button>
      <el-select
          v-model="value1"
          placeholder="请选择查询方式"
    ...
    <div>
      ...
      <el-dialog v-model="addDialogVisible2" title="新增分类" width="30%">
        <el-form ref="newCategoryFormRef" :model="newCategoryForm" label-position="left">
      ...
      <el-dialog v-model="addDialogVisible1" title="新增漏洞" width="30%">
        <el-form ref="newLoopHoleFormRef" :model="newLoopHoleForm" label-position="left">
...
const add2 = (form) => {
  axios.post('/loophole/category/create', {
