  ...
  <div style="display:flex; flex-direction: column; width: 100%">
    <div>
      ...
      <el-button
          ...
          @click="queryLoopHole">漏洞管理
      </el-button>
      <el-button
          type="primary"
          style="display: flex; float: right; margin-bottom: 20px; margin-right: 10px"
          @click="queryCategory">分类管理
      </el-button>
      <el-select v-show="loopHoleShow"
          clearable
          v-model="value1"
          placeholder="请选择查询方式"
      ...
      <el-input v-show="loopHoleShow"
                v-model="relateId"
                placeholder="请输入相应ID"
                style="width: 180px; margin-bottom: 20px"/>
      <el-button v-show="loopHoleShow"
                 @click="queryCategoryByOption"
                 style="margin-bottom: 20px; margin-right: 40px">查询</el-button>
...
<!--      <el-button v-show="!loopHoleShow" @click="queryCategoryById" style="margin-bottom: 20px">查询</el-button>-->
    ...
    <div>
      <el-button v-show="!loopHoleShow" type="primary" @click="addDialogVisible2 = true">新增分类</el-button>

      <el-button v-show="loopHoleShow" type="primary" @click="addDialogVisible1 = true">新增漏洞</el-button>
      ...
      <div v-show="loopHoleShow" style="margin-top: 10px; display: flex; flex-direction: row; flex-wrap: wrap">
...
<!--        />-->
        <el-card class="card" v-for="(item, index) in datas" :key="index" style="width: 390px; margin: 10px">
          <template #header>
            {{ item.holeName }}
          </template>
          <div>
          ...
          <template #footer>
            <el-button @click="showCategory(item)" style="width: 90px;">查看明细</el-button>
            <el-button @click="deleteRow1(item)" style="width: 90px;">删除漏洞</el-button>
            <el-button @click="showEditDialog1(item)" style="width: 90px;">编辑漏洞</el-button>
          </template>
        </el-card>
      </div>
        ...
        <el-table :data="datas2.slice((currentPage - 1) * pageSize, currentPage * pageSize)">
          ...
          <el-table-column label="操作">
            <template #default="{ row }">
              ...
              <el-button link type="primary" @click="showLoopHole(row)" style="width: 90px;">查看明细</el-button>
    ...
    <el-dialog v-model="editDialogVisible1" title="编辑漏洞" width="30%">
      <el-form ref="editForm1Ref" :model="editForm1" label="70px" label-position="left" label-width="auto">
        <el-form-item label="分类ID" prop="categoryId">
