<template>
  <div style="display: flex; flex-direction: column; ">
    <div class="title" style="text-align: center;"><h4>安全态势感知总览</h4></div>
    <div class="chart-container" style="display: flex; flex-direction: row; flex-wrap: wrap">
...
const drawChart = () => {
  ...
  const option4 = {
    ...
    yAxis: {
      type: 'category',
      data: ['设计错误', '输入验证错误', '边界条件错误', '访问验证错误', '竞争条件错误']
    },
    grid: {
      x: 100,
      y: 25,
