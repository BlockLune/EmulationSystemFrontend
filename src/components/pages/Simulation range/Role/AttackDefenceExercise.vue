...
<!-- 新增配置 -->
  ...
  <el-dialog v-model="addDialogVisible" title="新增演练" width="30%">
    ...
    <el-form
      ...
      label-position="left"
    >
      <el-form-item label="演练名称" prop="key">
        <el-input v-model="newConfigForm.key" placeholder="单行输入" />
      </el-form-item>
      <el-form-item label="演练靶机" prop="value">
        <el-input v-model="newConfigForm.value" placeholder="单行输入" />
      </el-form-item>
      <el-form-item label="演练启动时间" prop="startTime">
        <el-input v-model="newConfigForm.startTime" placeholder="单行输入" />
      </el-form-item>
      <el-form-item label="演练停止时间" prop="stopTime">
        <el-input v-model="newConfigForm.stopTime" placeholder="单行输入" />
      </el-form-item>
