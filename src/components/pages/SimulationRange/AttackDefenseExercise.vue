<template>
  <div style="display: flex; flex-direction: column; width: 100%">
    ...
    <div style="width: 100%">
      ...
      <el-button style="float: right" type="primary" @click="query">查询</el-button>
<!--      @click="queryPluginByOption"-->

      <el-button size="default" type="primary" @click="addDialogVisible = true">新增</el-button>
...
<!--        </el-form-item>-->
    ...
    >
      <el-descriptions title="演练信息" :column="2" border>
        <el-descriptions-item label="演练名称">{{ selectedRow.exerciseName }}</el-descriptions-item>
        <el-descriptions-item label="靶机镜像">{{ selectedRow.targetImageName }}</el-descriptions-item>
        <el-descriptions-item label="演练状态">{{ selectedRow.status }}</el-descriptions-item>
        <el-descriptions-item label="攻击镜像">{{ selectedRow.attackImageName }}</el-descriptions-item>
        <el-descriptions-item label="攻击次数">{{ selectedRow.attackTimes }}</el-descriptions-item>
        <el-descriptions-item label="防御镜像">{{ selectedRow.defendImageName }}</el-descriptions-item>
        <el-descriptions-item label="防御次数">{{ selectedRow.defendTimes }}</el-descriptions-item>
        ...
        <el-descriptions-item label="攻击开始时间">{{ selectedRow.attackStartTime }}</el-descriptions-item>
        <el-descriptions-item label="攻击结束时间">{{ selectedRow.attackEndTime }}</el-descriptions-item>
        <el-descriptions-item label="防御开始时间">{{ selectedRow.defendStartTime }}</el-descriptions-item>
        <el-descriptions-item label="防御结束时间">{{ selectedRow.defendEndTime }}</el-descriptions-item>
        <!-- 根据需要添加更多的描述项 -->
      </el-descriptions>
      <template #footer>
        <span class="dialog-footer">
...
<!--        <el-table-column show-overflow-tooltip prop="id" label="ID"></el-table-column>-->
        <el-table-column show-overflow-tooltip prop="exerciseName" label="演练名称"></el-table-column>
<!--        <el-table-column show-overflow-tooltip prop="targetImageId" label="靶机镜像"></el-table-column>-->
        <el-table-column show-overflow-tooltip prop="targetImageName" label="靶机镜像"></el-table-column>
...
<!--        <el-table-column show-overflow-tooltip prop="updateTime" label="更新时间"></el-table-column>-->
        <el-table-column show-overflow-tooltip prop="status" label="演练状态" ></el-table-column>
        <el-table-column show-overflow-tooltip prop="attackImageName" label="攻击镜像"></el-table-column>
<!--        <el-table-column show-overflow-tooltip prop="attackImageId" label="攻击镜像"></el-table-column>-->
        <el-table-column show-overflow-tooltip prop="attackTimes" label="攻击次数"></el-table-column>
        <el-table-column show-overflow-tooltip prop="defendImageName" label="防御镜像"></el-table-column>
<!--        <el-table-column show-overflow-tooltip prop="defendImageId" label="防御镜像"></el-table-column>-->
        <el-table-column show-overflow-tooltip prop="defendTimes" label="防御次数"></el-table-column>
        ...
        <el-table-column show-overflow-tooltip prop="attackStartTime" label="攻击开始时间"></el-table-column>
        <el-table-column show-overflow-tooltip prop="attackEndTime" label="攻击结束时间"></el-table-column>
        <el-table-column show-overflow-tooltip prop="defendStartTime" label="防御开始时间"></el-table-column>
        <el-table-column show-overflow-tooltip prop="defendEndTime" label="防御结束时间"></el-table-column>
